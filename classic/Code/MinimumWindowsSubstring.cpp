    ...
    string minWindow(string S, string T) {
        ...
        for(int i=0;i<S.size();i++){
            ...
            if(contain(appear,expect)){
                ...
                for(;j<=i;j++){
                    appear[S[j]-'A']--;
                    cout<<i<<j<<appear[S[j]-'A']<<contain(appear,expect)<<minV<<endl;
...
int main(int argc,char**argv){
    ...
    //string a="vniiysovqrkhmwxqwjpnkjwnuvbdwnatakbbfsyxjkgxgfnfqcsanqqkltnhgpcjcekjwkihuofcvuhlzznmpdwdzlkfdnohtaqrmaygqfjlaqyzsnnjrmmqzzxcooljqbaddyltewggnefhsuslg";
    //string b="fdggckwswfjzfoddzwjwd";
    //string a="ab",b="b";
    string a="bdab",b="ab";
    //string a="", b="xbnpukocakzqzuhdlxoga";
    //string a="", b="ftpejujeztahrwljlao";
